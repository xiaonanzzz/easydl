...
def agglomerative_clustering_pairwise_cosine_distance_with_threshold(df_embeddings, threshold) -> pd.DataFrame:
    """
    ...
    assert 'embedding' in df_embeddings.columns, "df_detections must have embedding column"
