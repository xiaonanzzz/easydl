...
def get_train_dataset_with_image_and_encoded_labels() -> GenericXYLambdaAutoLabelEncoderDataset:
    """
...
def get_test_dataset_with_image_and_encoded_labels() -> GenericXYLambdaAutoLabelEncoderDataset:
    """
...
def get_small_train_dataset_with_image_and_encoded_labels(num_samples: int=200) -> GenericXYLambdaAutoLabelEncoderDataset:
    """
